...
">¿Podemos ayudarle?</span></h2>
    ...
    <div id="slider">
        <div><img src="images/pestcontrol1.jpg" style="display: inline; height: 388px; width: 948px;"></div>
        <div><img src="images/pestcontrol2.jpg" style="display: inline; height: 388px; width: 948px;"></div>
        <div><img src="images/pestcontrol3.jpg" style="display: inline; height: 388px; width: 948px;"></div>
    </div>
    ...
    <div id="contentSections" class="group" style="padding-left: 50;">
    	<div id="welcomeCol" class="floatLeft">
            ...
            <section id="welcomeContent">
                <h1>Particulares y Hogares</h1>
                <div class="textile">
                    <div class="welcome-text">
<div class="welcome-upper">
</br>
<p>La presencia de plagas en su Hogar es mucho más que un mero inconveniente, suponen un serio riesgo para la salud en especial en cocinas, dormitorios o donde juegan los niños. </p>
<p>Es necesaria una acción inmediata para acabar con los problemas de plagas en los hogares con el fin de evitar su propagación por toda la casa y a sus vecinos. </p>
</div>
    	...
    	<section id="welcomeContent">
                <h1 style="width: 380;">Servicios a Empresas</h1>
                <div class="textile">
                    <div class="welcome-text">
<div class="welcome-upper">
</br>
<p>Somos una empresa líder en la prestación de servicios de Control de Plagas en empresas e industrias. Permitanos ofrecerle una máxima protección contra las plagas en su negocio.</p>
<p>Hemos desarrollado servicios específicos para cada tipo de negocio, ofreciendo el apropiado nivel de protección para cada uno. Nuestro programa siempre está respaldado por una inspección inicial previa que identifica todos los riesgos específicos.</p>
