...
">¿Podemos ayudarle?</span></h2>
    ...
    <div id="slider">
        <div><img src="images/lavanderia1.jpg" style="display: inline; height: 388px; width: 948px;"></div>
        <div><img src="images/lavanderia2.jpg" style="display: inline; height: 388px; width: 948px;"></div>
       <div><img src="images/lavanderia3.jpg" style="display: inline; height: 388px; width: 948px;"></div>
    </div>
...
<ul>
<li>Ropa blanca o color para todas las aplicaciones</li>
<li>Lavado y manipulación con estricta higiene</li>
<li>Servicio de toallas para gimnasios</li>
<li>Reparto de 1 a 7 veces a la semana</li>
<li>Precio mínimo garantizado</li>
<li>Servicio en todas las provincias</li>
</ul>
...
<p>Para conseguir la calidad y el precio requerido  centramos nuestra política de calidad en:</p>

<h1>Profesionalidad</h1>
</br>
<p>La capacidad técnica y organizativa son determinantes  conseguir los estándares de calidad requeridos.</p>
</div>
</div>
                </div><!-- textile -->
...
<p>La combinación de tecnología y eficiencia permite conseguir los estándares requeridos al menor coste.</p>

<h1>Honestidad</h1>
</br>
<p> Exigimos  a todos nuestros operarios y colaboradores el mayor nivel de ética y honestidad en las prácticas comerciales.</p>

<h1>Atención al cliente</h1>
</br>
<p> Todas las actividades están dirigidas a satisfacer las necesidades del cliente.</p>
</div>
